            ...
            <div class="card">               
                ...
                <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <tr class="text-capitalize">
                        ...
                        <td><?= $cnt['fullname']; ?></td>
                        <td>
                          <input type="time" name="morning_in" class="form-control" value="<?php if($cnt['morning_in'] != NULL){ 
                          echo date('H:m:s', strtotime($cnt['morning_in']));
                        } ?>">
                        </td>                        
                        <td>
                          <input type="time" name="morning_out" class="form-control" value="<?php if($cnt['morning_out'] != NULL){ 
                            echo date('H:m:s', strtotime($cnt['morning_out']));
                          } ?>">
                        </td>
                        <td>
                          <input type="time" name="afternoon_in" class="form-control" value="<?php if($cnt['afternoon_in'] != NULL){ 
                            echo date('H:m:s', strtotime($cnt['afternoon_in']));
                          } ?>">
                        </td>
                        <td>
                          <input type="time" name="afternoon_out" class="form-control" value="<?php if($cnt['afternoon_out'] != NULL){ 
                            echo date('H:m:s', strtotime($cnt['afternoon_out']));
                          } ?>">
                        </td>
                        <td><?= $cnt['log_date']; ?></td>
                        <td>
